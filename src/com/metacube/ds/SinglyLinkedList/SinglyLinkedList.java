 ...
 */
public class SinglyLinkedList<T extends Object> implements MyList<T>{
    ...
    public boolean remove(Object obj) {
        ...
        if (obj == null) {
            for (Node<T> current = head, prev = null; current != null; current = current.next, prev = current) {
    ...
    public T remove(int index) {
        ...
        return unlink(prev, current);
    }
    
    /**
     * Unlinks non-null node current.
     */
    private T unlink(Node<T> prev, Node<T> current) {
        // assert x != null;
