...
public class FileDao implements BaseDao{
    ...
    /** Constant String Location of file */
    private static final String PRODUCTS_FILE_PATH = "./src/products.csv";
     ...
     */
    public FileDao() {
        file= new FileHelper(PRODUCTS_FILE_PATH).getFile();
    }
    ...
    public List<Product> getAllProduct() {
        try{
            ...
            while((line = sc.readLine())!=null){
                /**Splitting the detail using , as a delimiter**/
