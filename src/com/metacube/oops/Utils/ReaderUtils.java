package com.metacube.oops.Utils;
...
public class ReaderUtils {
     ...
     */
    public ReaderUtils(String fileName) throws FileNotFoundException {
        try {
     ...
     */
     public ReaderUtils(InputStream inputStream) {
        ...
        try {
            while ((line = reader.readLine()) != null) {
                if (!line.equalsIgnoreCase("")) {
                     ...
                     */
                    if (!ValidationNetworkUtils.checkName(lineArray[0])) {
                     ...
                     */
                    if (!ValidationNetworkUtils.checkMail(lineArray[1])) {
                     ...
                     */
                    if (!ValidationNetworkUtils.checkDuplicacy(lineArray[1])) {
                     ...
                     */
                    if (!ValidationNetworkUtils.checkNumber(lineArray[2])) {
